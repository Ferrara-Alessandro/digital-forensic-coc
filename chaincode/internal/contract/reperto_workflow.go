...
// Il PM chiede l'analisi: registro il decreto e preparo i dati per il laboratorio.
...
// Elenco delle modifiche successive alla scheda pubblica del reperto.
...
// Converto il timestamp Fabric in testo leggibile per la cronologia.
