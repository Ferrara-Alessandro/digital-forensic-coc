...
// Mi serve per costruire chiavi composte su Fabric quando indicizzo documenti ed evidenze.
...
// Chiave sotto cui salvo i metadati privati di un file (caso e id file).
...
// Leggo il JSON inviato nel transient e controllo cid e chiave.
...
// Obbligo la chiave di cifratura: senza non registro il file.
