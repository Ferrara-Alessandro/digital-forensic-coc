...
Smart contract Fabric (Go, contract-api): custodia reperto, documenti tipizzati, evidenze. Contenuti file su IPFS; puntatori e chiavi in PDC.

Vedi anche [README principale](../../README.md) per il modello dati completo.
