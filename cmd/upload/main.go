...
// Alla fine stampo un riepilogo in JSON.
package main
...
// Normalizzo la modalita' scelta da riga di comando.
func normalizeMode(mode string) string {
	return strings.ToLower(strings.TrimSpace(mode))
}

// Scelgo quale organizzazione firma in base al tipo di atto.
...
// Modalita' reperto: chiamo CreaReperto con i dati nel transient.
...
// Modalita' documento: cifro, IPFS, poi registro su Fabric.
...
// Modalita' evidenza: come documento ma per file generici.
...
// Cifro il file a pezzi e lo carico su IPFS tenendolo pinato.
